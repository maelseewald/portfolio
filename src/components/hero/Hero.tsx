...
import GlobeLoader from "../GlobeLoader.tsx";
...
export default function Hero() {
    ...
    return (
        <div className="relative flex min-h-screen flex-col items-center justify-center px-6">
            {/* Available badge */}
            <motion.div
                className="mb-6 flex items-center gap-2 rounded-full border border-(--color-surface-hover) bg-(--color-surface) px-4 py-1.5"
