...
export const LiquidGlassCard = ({
    ...
    const shadowStyles = {
        ...
        xs: 'inset 1px 1px 1px 0 var(--glass-highlight, rgba(255, 255, 255, 0.3)), inset -1px -1px 1px 0 var(--glass-highlight, rgba(255, 255, 255, 0.3))',
        sm: 'inset 2px 2px 2px 0 var(--glass-highlight, rgba(255, 255, 255, 0.35)), inset -2px -2px 2px 0 var(--glass-highlight, rgba(255, 255, 255, 0.35))',
        md: 'inset 3px 3px 3px 0 var(--glass-highlight, rgba(255, 255, 255, 0.45)), inset -3px -3px 3px 0 var(--glass-highlight, rgba(255, 255, 255, 0.45))',
        lg: 'inset 4px 4px 4px 0 var(--glass-highlight, rgba(255, 255, 255, 0.5)), inset -4px -4px 4px 0 var(--glass-highlight, rgba(255, 255, 255, 0.5))',
        xl: 'inset 6px 6px 6px 0 var(--glass-highlight, rgba(255, 255, 255, 0.55)), inset -6px -6px 6px 0 var(--glass-highlight, rgba(255, 255, 255, 0.55))',
        '2xl':
            'inset 8px 8px 8px 0 var(--glass-highlight, rgba(255, 255, 255, 0.6)), inset -8px -8px 8px 0 var(--glass-highlight, rgba(255, 255, 255, 0.6))',
    };
